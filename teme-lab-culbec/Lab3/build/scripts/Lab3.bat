...
set CLASSPATH=%APP_HOME%\lib\Lab3-1.0-SNAPSHOT.jar;%APP_HOME%\lib\log4j-core-2.23.1.jar;%APP_HOME%\lib\log4j-api-2.23.1.jar;%APP_HOME%\lib\mariadb-java-client-3.3.3.jar;%APP_HOME%\lib\waffle-jna-3.3.0.jar;%APP_HOME%\lib\jna-platform-5.13.0.jar;%APP_HOME%\lib\jna-5.13.0.jar;%APP_HOME%\lib\jcl-over-slf4j-2.0.7.jar;%APP_HOME%\lib\slf4j-api-2.0.7.jar;%APP_HOME%\lib\caffeine-2.9.3.jar;%APP_HOME%\lib\checker-qual-3.32.0.jar;%APP_HOME%\lib\error_prone_annotations-2.10.0.jar


@rem Execute Lab3
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LAB3_OPTS%  -classpath "%CLASSPATH%" ro.mpp2024.lab3.MainBD %*
